...
var myBar = new Chart(ctxBar, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Inovasi',
            backgroundColor: [chartColors.red, chartColors.purple, chartColors.blue, chartColors.orange, chartColors.info],
            data: [
                10,
                10,
                30,
