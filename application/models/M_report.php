    ...
    class  M_report extends CI_Model 
        {
            ...
            public function get_data($limit, $start, $keyword = null)
                {
                    if ($keyword) {
                        ...
                        $this->db->or_like('account_vendor', $keyword) ;
                    ...
                    return $this->db->get('tb_report', $limit, $start)->result_array() ;
                }
            ...
            public function detail_data($id = NULL)
                {
                    $query = $this->db->get_where('tb_report', array('id' => $id))->row();
                    return $query ;
                }
            ...
            function gettahun()
                {
                    $query = $this->db->query(" SELECT YEAR(tanggal) AS tahun FROM tb_report
            ...
            function filterbytanggal($tanggalawal, $tanggalakhir)
                {
                    $query = $this->db->query(" SELECT * FROM tb_report where tanggal BETWEEN '$tanggalawal'
            ...
            function filterbybulan($tahun1, $bulanawal, $bulanakhir)
                {
                    $query = $this->db->query(" SELECT * FROM tb_report where YEAR(tanggal) = '$tahun1' and MONTH(tanggal)
            ...
            function filterbytahun($tahun2)
                {
                    $query = $this->db->query(" SELECT * FROM tb_report where YEAR(tanggal) = '$tahun2' ORDER BY tanggal ASC ") ;
