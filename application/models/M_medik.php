<?php
    class  M_medik extends CI_Model 
        {
            public function tampil_data()
                {
                    return $this->db->get('tb_medik');
                }
            ...
            public function get_data($limit, $start, $keyword = null)
                {
                    ...
                    return $this->db->get('tb_medik', $limit, $start)->result_array() ;
                }
            ...
            public function detail_data($id = NULL)
                {
                    $query = $this->db->get_where('tb_medik', array('id' => $id))->row();
                    return $query ;
                }
            ...
            function gettahun()
                {
                    $query = $this->db->query(" SELECT YEAR(tanggal) AS tahun FROM tb_medik
            ...
            function filterbytanggal($tanggalawal, $tanggalakhir)
                {
                    $query = $this->db->query(" SELECT * FROM tb_medik where tanggal BETWEEN '$tanggalawal'
            ...
            function filterbybulan($tahun1, $bulanawal, $bulanakhir)
                {
                    $query = $this->db->query(" SELECT * FROM tb_medik where YEAR(tanggal) = '$tahun1' and MONTH(tanggal)
            ...
            function filterbytahun($tahun2)
                {
                    $query = $this->db->query(" SELECT * FROM tb_medik where YEAR(tanggal) = '$tahun2' ORDER BY tanggal ASC ") ;
