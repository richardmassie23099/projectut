                            ...
                            <div class="card">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo base_url('medik/print_medik') ?>"><i class="bi bi-file-earmark-pdf-fill"></i> Print Semua Data</a></li>
                                        <li><a class="dropdown-item" href="<?php echo base_url('medik/cetak_medik') ?>"><i class="bi bi-file-earmark-pdf-fill"></i> Pilihan Lain</a></li>
                                    </ul>
                                </div>
                                <br><br>
                                ...
                                <!-- <div class="row">
                                    <div class="col-md">
                                        <form action="<?php echo base_url('medik/index') ; ?>" method="POST">
                                    ...
                                    <table class="table text-center" id="table1">
                                        <thead>                            
                                            <tr class="table-secondary">
                                                ...
                                                <th class="text-center">Jumlah (Qyt)</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($medik as $med) : ?>
                                                <tr>
                                                    ...
                                                    <!-- <td><?php echo anchor('medik/detail_medik/'.$med['id'], '<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>') ?></td> -->
                                                    <?php if ($_SESSION['hak_akses'] == 'O' or $_SESSION['hak_akses'] == 'A' ) { ?>
                                                        <td><?php echo anchor('medik/edit_medik/'.$med['id'], '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                                                        <td onclick="javascript: return confirm('Anda Yakin Untuk Meng - HAPUS Data Ini ?')"><?php echo anchor('medik/hapus/'.$med['id'], '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Input Monitoring Kondisi medik</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <?php echo form_open_multipart('medik/tambah_aksi') ; ?>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Penggunaan</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="penggunaan" class="form-control" value="Kendaraan / A2B" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="dimensi" class="form-control" value="16,5 x 12,5 x 6" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="nama_obat" class="form-control">
                                            ...
                                            <option>Plester Gulung Kecil</option>
                                            <option>Gunting Pembalut</option>
                                            <option>Pinset</option>
                                            <option>Personal Bag</option>
                                        </select>
                                    </div>
                                </div>
