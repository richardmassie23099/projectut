            ...
            <div class="page-heading">
                <h3>KOTAK P3K - PORTABLE FAK (2-5 Orang)</h3>
                <hr>
            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo base_url('medik3/print_medik3') ?>"><i class="bi bi-file-earmark-pdf-fill"></i> Print Semua Data</a></li>
                                        <li><a class="dropdown-item" href="<?php echo base_url('medik3/cetak_medik3') ?>"><i class="bi bi-file-earmark-pdf-fill"></i> Pilihan Lain</a></li>
                                    </ul>
                                </div>
                                <br><br>
                                ...
                                <!-- <div class="row">
                                    <div class="col-md">
                                        <form action="<?php echo base_url('medik3/index') ; ?>" method="POST">
                                        ...
                                        <tbody>
                                            <?php foreach ($medik3 as $med) : ?>
                                                <tr>
                                                    ...
                                                    <!-- <td><?php echo anchor('medik3/detail_medik3/'.$med['id'], '<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>') ?></td> -->
                                                    <?php if ($_SESSION['hak_akses'] == 'O' or $_SESSION['hak_akses'] == 'A' ) { ?>
                                                        <td><?php echo anchor('medik3/edit_medik3/'.$med['id'], '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                                                        <td onclick="javascript: return confirm('Anda Yakin Untuk Meng - HAPUS Data Ini ?')"><?php echo anchor('medik3/hapus/'.$med['id'], '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Input Kondisi Portable FAK (2-5 Orang)</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <?php echo form_open_multipart('medik3/tambah_aksi') ; ?>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Penggunaan</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="penggunaan" class="form-control" value="Portable FAK (2-5 Orang)" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="dimensi" class="form-control" value="27 x 19 x 22" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="nama_obat" class="form-control">
                                            ...
                                            <option>Kassa Steril 5x5 cm</option>
                                            ...
                                            <option>Povidone Iodine 30 ml</option>
                                            <option>Elastic Bandage 3"</option>
                                            <option>Cotton Buds</option>
                                            <option>Plester Gulung Besar</option>
