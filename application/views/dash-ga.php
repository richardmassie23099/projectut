...
<head>
    ...
    <title>Dashboard GA | E-Ewako Apps</title>
    ...
    <div id="app">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item active">
                            <a href="<?php echo base_url() ?>adm/dashga" class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url() ?>report/index" class='sidebar-link'>
                                <i class="bi bi-display"></i>
                                <span>Monitoring AP</span>
                            </a>
                        </li>
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3 class="text-center">DASHBOARD GA</h3>
                <hr>
            </div>
                                    ...
                                    <div class="card-body px-1 py-1-1">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 text-center">
                                                <img src="<?php echo base_url() ?>assets/assets/images/icon/ga-monitor.png" width="70px">    
                                                <h6 class="font-extrabold  mt-2">MONITORING AP</h6>
                                            </div>
                                        </div>
                                    </div>
                                    </a>
