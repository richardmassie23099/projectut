            ...
            <div class="page-heading">
                <h3>KOTAK P3K - AREA RESIKO BASAH</h3>
                <hr>
            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo base_url('medik4/print_medik4') ?>"><i class="bi bi-file-earmark-pdf-fill"></i> Print Semua Data</a></li>
                                        <li><a class="dropdown-item" href="<?php echo base_url('medik4/cetak_medik4') ?>"><i class="bi bi-file-earmark-pdf-fill"></i> Pilihan Lain</a></li>
                                    </ul>
                                </div>
                                <br><br>
                                ...
                                <!-- <div class="row">
                                    <div class="col-md">
                                        <form action="<?php echo base_url('medik4/index') ; ?>" method="POST">
                                        ...
                                        <tbody>
                                            <?php foreach ($medik4 as $med) : ?>
                                                <tr>
                                                    ...
                                                    <!-- <td><?php echo anchor('medik4/detail_medik4/'.$med['id'], '<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>') ?></td> -->
                                                    <?php if ($_SESSION['hak_akses'] == 'O' or $_SESSION['hak_akses'] == 'A' ) { ?>
                                                        <td><?php echo anchor('medik4/edit_medik4/'.$med['id'], '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                                                        <td onclick="javascript: return confirm('Anda Yakin Untuk Meng - HAPUS Data Ini ?')"><?php echo anchor('medik4/hapus/'.$med['id'], '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Input Kondisi Area Resiko Basah</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <?php echo form_open_multipart('medik4/tambah_aksi') ; ?>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Penggunaan</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="penggunaan" class="form-control" value="Area Resiko Basah" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="dimensi" class="form-control" value="28 x 32 x 11,5" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="nama_obat" class="form-control">
                                            ...
                                            <option>Elastic Bandage 3"</option>
                                            <option>Emergency Blanket</option>
                                            <option>Instant Coldpack</option>
                                            <option>Handyclean 50 ml</option>
